...
from preprocess import cell_types_lung, Preprocess
...
if __name__ == "__main__":
    ...
    preprocess = Preprocess(args.directory, args.platform, args.source, args.sample, args.force_annotate, args.force_categorize)
